...
- [x] Fix runtime_debug_feature.go: pass accumulated content, not just delta, in EventReasoningTextDelta handler
- [x] Add EventReasoningTextDelta handling to JS api_events.go encoder
- [x] Verify timeline ProjectTimeline accumulation works end-to-end with sessionstream
- [x] Add integration test for thinking content accumulation across OpenAI completion API
