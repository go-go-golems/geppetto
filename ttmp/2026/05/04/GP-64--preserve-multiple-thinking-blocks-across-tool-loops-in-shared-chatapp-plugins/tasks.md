...
- [x] Add segment-aware identity to ReasoningPlugin
...
- [x] Add backend tests for interleaved thinking/tool/text transcript identity
- [x] Update CoinVault frontend parser/tests for clean shared schemas only
- [x] Run pinocchio, coinvault, and web validation
