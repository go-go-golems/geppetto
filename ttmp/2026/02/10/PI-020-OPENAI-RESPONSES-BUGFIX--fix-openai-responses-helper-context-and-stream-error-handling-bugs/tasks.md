...
- [ ] Bug 2 test-first: add streaming regression test proving SSE error currently returns success
- [ ] Bug 2 fix: return streamErr and suppress final success event when streaming fails
- [ ] Bug 1 commit: commit helper+test+diary updates
- [ ] Bug 2 validation: run focused openai_responses tests and confirm error propagation semantics
