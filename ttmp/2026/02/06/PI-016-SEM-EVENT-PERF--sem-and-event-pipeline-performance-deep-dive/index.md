...
This ticket captures bottleneck analysis and optimization planning for high-rate SEM/event flows.

## Key Links

- Analysis: `analysis/01-sem-and-event-pipeline-performance-deep-dive-and-plan.md`
- Tasks: `tasks.md`
