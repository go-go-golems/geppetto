...
This ticket defines a durable EventStore that complements the live in-memory SEM buffer and enables postmortem event analysis.

## Key Links

- Analysis: `analysis/01-eventstore-design-for-postmortem-debug-mode.md`
- Tasks: `tasks.md`
