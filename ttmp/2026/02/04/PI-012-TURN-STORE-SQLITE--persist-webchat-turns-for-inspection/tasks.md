...
- [x] Add snapshot inspection runbook (PINOCCHIO_WEBCHAT_TURN_SNAPSHOTS_DIR) and tmux launch notes
- [x] Define TurnStore interface + SQLite implementation (schema, migrations)
