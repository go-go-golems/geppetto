...
<details>
  ...
  <!-- Placeholder, metadata object details not provided in original HTML -->
...
See our [beta guide](https://docs.anthropic.com/claude/docs/tool-use) for more details.
...
<details>
  <summary>200 - Message object</summary>
...
- stop_reason (required)
    ...
    - Option 1:
      ...
      <!-- Placeholder, option details not provided in original HTML -->
...
<details>
  <summary>4XX - Error response</summary>

See our [errors documentation](https://docs.anthropic.com/claude/reference/errors) for more details.
