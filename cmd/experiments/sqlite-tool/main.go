...
func main() {
    if err := clay.InitViper("pinocchio", rootCmd); err != nil { panic(err) }
    ...
    cmd := &cobra.Command{
        ...
        RunE: func(cmd *cobra.Command, args []string) error {
            ...
            if err != nil { return errors.Wrap(err, "inference failed") }
    ...
    if err := rootCmd.Execute(); err != nil { log.Error().Err(err).Msg("sqlite-tool failed") }
}
